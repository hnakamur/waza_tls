...
// pub fn bitLenAbs(n: Const) usize {
//     return n.bitCountAbs();
// }

const testing = std.testing;

// test "bigint.bigLenAbs" {
//     testing.log_level = .debug;
//     const allocator = testing.allocator;

//     var n = try managedFromBytes(
//         allocator,
...
//     try testing.expectEqual(@as(usize, 2048), bitLenAbs(n.toConst()));
// }
